package com.vise.bledemo.haikang;
...
public class MainActivity extends Activity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainces);
        ...
        m_oLoginBtn.setOnClickListener(new OnClickListener(){
        ...
        m_oLoginBtn2.setOnClickListener(new OnClickListener(){
        ...
        m_oLoginBtn3.setOnClickListener(new OnClickListener(){
        ...
        m_oPreviewBtn.setOnClickListener(new OnClickListener(){
            public void onClick(View v) {
                try {
                    if (m_iLogID < 0) {
