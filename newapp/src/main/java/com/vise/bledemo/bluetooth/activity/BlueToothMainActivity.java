...
import com.vise.bledemo.bluetooth.adapter.DeviceMainAdapter;
...
import static com.vise.bledemo.baiduMap.utils.PublicMethod.isPad;
import static com.vise.bledemo.baiduMap.utils.PublicMethod.isWifi;
...
public class BlueToothMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       // Toast.makeText(this, ""+isWifi(BlueToothMainActivity.this), Toast.LENGTH_SHORT).show();
...
//        Intent intent = new Intent(BlueToothMainActivity.this, com.vise.bledemo.baiduMap.baiduMap.view.WelcomeActivity.class);
//        startActivity(intent);

        Intent intent = new Intent(BlueToothMainActivity.this, DeviceScanActivity.class);
        startActivity(intent);
        finish();
        isPad(BlueToothMainActivity.this);
    }
    ...
    private void init() {
        ...
        deviceLv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent intent = new Intent(BlueToothMainActivity.this, DeviceControlActivity.class);
    ...
    public void showConnectedDevice(ConnectEvent event) {
        if (event != null) {
            ...
            if (event.isDisconnected()) {
                ToastUtil.showToast(BlueToothMainActivity.this, "Disconnect!");
            }
        }
    }
