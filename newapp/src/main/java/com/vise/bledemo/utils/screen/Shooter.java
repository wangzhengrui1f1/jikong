package com.vise.bledemo.utils.screen;
...
//            mLocalUrl= getContext().Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES),
//                    "手动取证"+disposeTime()+".png";
        }
        return mLocalUrl;
    }
