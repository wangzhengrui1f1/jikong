...
public class Adapter_SearchAddress2 extends BaseAdapter {
    private LatLng currentLatLng;
    private List<PoiInfo> oList;
    private Context ocontext;
    private LayoutInflater oInflater;
    Map<Integer, Boolean> choose;
    public Adapter_SearchAddress2(List<PoiInfo> oList, Context context, LatLng currentLatLng) {
        this.oList = oList;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = oInflater.inflate(R.layout.item_search_address2, null);
...
//        });
        ...
        if (selectedPosition == position) {
            ...
            getdidian=poiInfo.name+" ("+poiInfo.address+")";
        } else {
            viewHolder.iv_point.setImageResource(R.drawable.point_gray);
            viewHolder.tv_name.setTextColor(ocontext.getResources().getColor(R.color.white));
        }
